...
class PassportFrontInstructionFragment : BasePhotoInstructionFragment() {
    ...
    override fun getInstructionTitleRes() = R.string.nur_process_flow_photo_instruction_passport_front
    override fun getInstructionSubtitleRes(): Int =
        R.string.nur_process_flow_photo_instructiin_passports_subtitle

    override fun getInstructionImageRes() = R.drawable.nur_process_flow_ic_instruction_id_card_front
}
