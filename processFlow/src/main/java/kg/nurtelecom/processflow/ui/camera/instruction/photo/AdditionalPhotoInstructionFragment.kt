...
class AdditionalPhotoInstructionFragment : BasePhotoInstructionFragment() {

    override fun getInstructionTitleRes() =
        R.string.nur_process_flow_photo_instruction_additional_photo

    override fun getInstructionSubtitleRes(): Int =
        R.string.nur_process_flow_photo_instruction_additional_photo_description
