...
class ForeignSelfiePhotoInstructionFragment : BaseFragment<NurProcessFlowFragmentPhotoSelfeInstrustionBinding>() {
    ...
    private fun setupPhotoInstructionView() {
        with(vb) {
            ...
            ivCorrect.loadImage(ProcessFlowConfigurator.foreignSelfieInstructionUrlResolver.invoke())
